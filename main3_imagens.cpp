...
int main(int argc, char *argv[]){
    ...
    static Mat b, g, r, image, RB, I2, I3, BW, H, strip;
    static Mat splitChannels[3];
    int thresh = 0;
    ...
    split(cam.frame_roi, splitChannels);
    ...
    static Mat strip1 = BW(Rect(0,0,n,number_pixel));
    static Mat strip2 = BW(Rect(0,number_pixel+1,n,number_pixel));
    static Mat strip3 = BW(Rect(0,number_pixel*2+1,n,number_pixel));
    static Mat strip4 = BW(Rect(0,number_pixel*3+1,n,number_pixel));
    static Mat strip5 = BW(Rect(0,number_pixel*4+1,n,number_pixel));
    static Mat strip6 = BW(Rect(0,number_pixel*5+1,n,number_pixel));
    static Mat strip7 = BW(Rect(0,number_pixel*6+1,n,number_pixel));
    static Mat strip8 = BW(Rect(0,number_pixel*7+1,n,number_pixel));
    static Mat strip9 = BW(Rect(0,number_pixel*8+1,n,number_pixel));
    static Mat strip10 = BW(Rect(0,number_pixel*9+1,n,number_pixel));
    static Mat strip11 = BW(Rect(0,number_pixel*10+1,n,number_pixel));
    static Mat strip12 = BW(Rect(0,number_pixel*11+1,n,number_pixel));
    static Mat strip13 = BW(Rect(0,number_pixel*12+1,n,number_pixel));
    static Mat strip14 = BW(Rect(0,number_pixel*13+1,n,number_pixel));
    static Mat strip15 = BW(Rect(0,number_pixel*14+1,n,number_pixel));
    static Mat strip16 = BW(Rect(0,number_pixel*15+1,n,number_pixel));
    static Mat strip17 = BW(Rect(0,number_pixel*16+1,n,number_pixel));
    static Mat strip18 = BW(Rect(0,number_pixel*17+1,n,number_pixel));
    static Mat strip19 = BW(Rect(0,number_pixel*18+1,n,number_pixel));
    static Mat strip20 = BW(Rect(0,image.rows-number_pixel-1,n,number_pixel));
    ...
    cam.houghP(strip, 60, ((strip.rows)*0.65), (strip.rows), 30, 135);
